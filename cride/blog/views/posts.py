...
from cride.blog.serializers.posts import ListPostSerializer, PostSerializer, RecentListPostSerializer
    ...
    def list(self, request):
        ...
        if search_q is not None:
            ...
            if len(search_q) > 3:
                ...
                ).filter(search=search_q).filter(rank__gte=0.3).order_by('-rank')
            else:
                queryset = Post.posted.none()
