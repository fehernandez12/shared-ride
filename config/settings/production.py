...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['.sharedrideapp.com'])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default='Shared Ride <noreply@sharedride.com>'
)
SERVER_EMAIL = env('DJANGO_SERVER_EMAIL', default=DEFAULT_FROM_EMAIL)
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[Shared Ride]')
